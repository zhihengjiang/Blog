...
public class PageUtil {
    ...
    public static String getPrevAndNextPageCode(Blog prev, Blog next, String projectContent) {
        ...
        if(next == null || next.getId() == null) {
            ...
            pageCode.append("<p>下一篇：<a href='" + projectContent + "/blog/articles/" + next.getId() + ".html'>" + next
                    .getTitle() + "</a></p>");
        }
    ...
    public static String getUpAndDownPageCode (
        ...
        if(totalPage == 0) {
            ...
            if(page > 1) {
                pageCode.append("<li><a href='"+projectContext+"/blog/search.html?page="+(page-1)+"&q="+q+"'>上一页</a" +
                        "></li>");
            } else {
                pageCode.append("<li class='disabled'><a>上一页</a></li>");
            }
            if(page < totalPage) {
                pageCode.append("<li><a href='"+projectContext+"/blog/search.html?page="+(page+1)+"&q="+q+"'>下一页</a" +
                        "></li>");
            } else {
                pageCode.append("<li class='disabled'><a>下一页</a></li>");
            }
